...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. Tedcoin can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
int main(int argc, char *argv[])
{
    ...
    if (!boost::filesystem::is_directory(GetDataDir(false)))
    {
        ...
        QMessageBox::critical(0, "Tedcoin",
    ...
    try {
        ...
        QMessageBox::critical(0, QObject::tr("Tedcoin"),
    ...
    app.setOrganizationName("Tedcoin");
    app.setOrganizationDomain("Tedcoin.su");
